...
import static com.example.activity_assistant_logger.weekview.WeekViewUtil.*;
...
public class WeekView extends View {
    ...
    private void drawEvents(Calendar date, float startFromPixel, Canvas canvas) {
        if (mEventRects != null && mEventRects.size() > 0) {
            for (int i = 0; i < mEventRects.size(); i++) {
                String debug = mEventRects.get(i).event.getStartTime().getTime() + " - " + mEventRects.get(i).event.getEndTime().getTime();
     ...
     * </p>
     *
     * @param length Supported values are {@link com.example.activity_assistant_logger.weekview.WeekView#LENGTH_SHORT} and
     *               {@link com.example.activity_assistant_logger.weekview.WeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    public interface EventLongPressListener {
        /**
         * Similar to {@link com.example.activity_assistant_logger.weekview.WeekView.EventClickListener} but with a long press.
         *
         * @param event:     event clicked.
         * @param eventRect: view containing the clicked event.
         */
    ...
    public interface EmptyViewLongPressListener {
        /**
         * Similar to {@link com.example.activity_assistant_logger.weekview.WeekView.EmptyViewClickListener} but with long press.
         *
