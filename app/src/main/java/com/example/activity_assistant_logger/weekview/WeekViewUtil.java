...
public class WeekViewUtil {
    ...
    */
    public static float getPassedMinutesInDay(Calendar date) {
        return getPassedMinutesInDay(date.get(Calendar.HOUR_OF_DAY), date.get(Calendar.MINUTE), date.get(Calendar.SECOND));
    }
     ...
     */
    public static float getPassedMinutesInDay(int hour, int minute) {
        return hour * 60 + minute;
    }

     public static float getPassedMinutesInDay(float hour, float minute, float second) {
